...
rm(list = ls())
data_path <- "C:/Users/capta/Downloads/IS403.Q12-/Data/Dataset/Apple_clean.csv"
...
p <- ggplot() +
  ...
  # Tiêu đề và trục
  labs(
    title = sprintf("Apple Closing Price (%s → %s)", min(df$Date), forecast_df$Date[nrow(forecast_df)]),
...
# Lưu file hình
save_path <- file.path("C:/Users/capta/Downloads/IS403.Q12-/Model/ARIMA/R/6_2_2/Image/Apple_ARIMA_622_R.png")
